...
public class ErrorMessage {
    ...
    public static final String EMPTY_STRING = "[ERROR] 빈 값은 허용하지 않습니다.";
    public static final String REQUIRE_NUMBER = "[ERROR] 숫자를 입력해주세요.";
    ...
    public static final String INPUT_ERROR = "[ERROR] 입력값이 존재하지 않습니다. 프로그램을 종료합니다.";
